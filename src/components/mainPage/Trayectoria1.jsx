    ...
    return (
        <Container sx={{ bgcolor: "", pt:2}}>
            <Grid container sx={{display:"flex", justifyContent:"space-around"}}>
                <Grid item md={6} sx={{display:"flex", justifyContent:"center", px: {xs:5, md:0}}}>
                    <img src='images/Trayectoria 2.png' style={{width:'auto', height:"100vh", aspectRatio:'1:1'}}></img>
                </Grid>
                <Grid item md={6} sx={{display:"flex", alignItems:"center", textAlign:{xs:"center", md:""}, px:4, pt:{xs:6, md:3}, bgcolor:"", fontFamily:"Quicksand"}}>
