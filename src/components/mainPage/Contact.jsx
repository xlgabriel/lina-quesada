...
import { Alert, Box, Button, Card, Container, Grid, Snackbar, TextField, Typography, Divider } from "@mui/material";
            ...
            emailjs.sendForm("service_o8idcdc", "template_rmb2gnf", form.current, "zQUdA2RITc4jr1SZv").then(
                ...
                (error) => {
                    ...
                    setSnackbar({
                        ...
                        vertical: "top",
                        horizontal: "center",
                        snackbarMessage: "Ha ocurrido un error. Por favor, intente de nuevo.",
                    });
                }
            );
        }
                ...
                <Grid container justifyContent="space-around">
                    ...
                    <Grid item xs={12} md={5}>
                        <Box>
                            <Box>
                                <Button
                                    sx={{ color: "#efb603", fontSize: "16px", textTransform: "none" }}
