      ...
      <Grid container sx={{ my: 3 }} gap={{xs:2,md:0}}>
        {
            [0.1,0.2,0.3].map((item)=>(
                <Grid item key={item} xs={12} md={4} component={motion.div} initial={{scale:0, opacity:0}} whileInView={{opacity:1, scale:1, rotate:360, transition:{delay:item,duration:1}}}>
                <Card sx={{ width: "90%", py: 1, mx:"auto"}}>
                  ...
                  <CardContent>
                    <Typography variant="body2" sx={{textAlign:"justify"}}>
                      <span style={{fontSize:"1rem",fontWeight:"bolder", fontFamily:"Merriweather"}}>"</span>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis
                      fuga nihil iure voluptates ducimus tempora voluptatibus cumque
                      veniam quod, asperiores nostrum, maxime iste, dicta ullam vel et
                      nesciunt ab quos.
                      <span style={{fontSize:"1rem",fontWeight:"bolder", fontFamily:"Merriweather"}}>"</span>
                    </Typography>
                  </CardContent>
