...
const Procedimientos = () => {
  ...
  return (
    <Container sx={{ backgroundColor: "", height: "auto", pt: 8, backgroundImage:"url(images/logo-lina-quesada-2-ps.png)", backgroundSize:{xs: "100% 50%", md:"auto 100%"}, backgroundPosition:"center", backgroundRepeat: "no-repeat" }}>
      <Typography
        variant="h3"
        sx={{
          color: goldColor1,
          ...
          {procedimientos.map((item, index) => (
            <Grid item xs={10} sm={8} md={6} lg={4}>
              ...
              >
                <CardMedia
                  component="img"
                  sx={{ width: {sm:'100%', md:"100%"}, height:{sm:'280px', md:"auto"}, aspectRatio: "1/1"}}
                  src={item.image}
